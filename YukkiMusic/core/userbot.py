...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("source_av")
                await self.one.join_chat("JK_ZG")
                await self.one.join_chat("DEVTOM_bot")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("source_av")
                await self.two.join_chat("JK_ZG")
                await self.two.join_chat("DEVTOM_bot")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("source_av")
                await self.three.join_chat("JK_ZG")
                await self.three.join_chat("DEVTOM_bot")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("source_av")
                await self.four.join_chat("JK_ZG")
                await self.four.join_chat("DEVTOM_bot")
            except:
                pass
            assistants.append(4)
            try:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("source_av")
                await self.five.join_chat("JK_ZG")
                await self.five.join_chat("DEVTOM_bot")
            except:
                pass
            assistants.append(5)
            try:
